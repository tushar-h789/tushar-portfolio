...
const About = () => {
  return (
    <div className="flex justify-between gap-8 mt-20 max-w-screen-xl mx-auto">
      <div className="w-1/2">
        <div>
        ...
        <Tabs>
          ...
          <TabPanel>
            <div>
              ...
              <p className="text-slate-600">
                ...
                vision to life. Your success is my priority, and I look forward
                to the opportunity to contribute to it through my skills and
                expertise
              </p>
            </div>
          </TabPanel>
          <TabPanel>
            <div>
              ...
              <p className="text-slate-600">
                My journey in the world of web development has equipped me with
                a versatile skill set. From crafting seamless user interfaces
                using HTML, CSS, and JavaScript on the front end to architecting
                robust and efficient server-side solutions with languages like
                Node.js and Python on the back end, I take pride in my ability
          ...
          <TabPanel>
            ...
            <div>
              ...
              <ul>
                <li className="my-2">
                  <strong>Technology Stack:</strong> React, React Hooks, Custom
                  Hooks, Context API, TanStackQuery, Tailwind CSS, Daisy UI,
                  Node.js, Express.js, MongoDB, React Formik, Firebase
                  Authentication, JWT Token for Security, swiper.
                </li>
                <li>
                  <strong>Features:</strong> E-commerce functionalities, User
            ...
            <div className="my-10">
              <h2 className="text-xl font-semibold">
                TrustBook - Social Media Application || Design and Social media
                application feature{" "}
              </h2>
            ...
            <div>
              ...
              <ul>
                <li className="my-2">
                  <strong>Technology Stack:</strong> React, Custom Hooks, React
                  Hooks, Context API, React Query, Tailwind CSS, Daisy UI,
                  Node.js, Express.js, MongoDB, React Tab, React Formik,
